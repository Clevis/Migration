 ...
 */
class Sql implements Migrations\IExtensionHandler
{
	...
	/**
	 * @param ExecutionRecord\Entities\File
	 * @return int number of queries
	 */
	public function execute(Migrations\Entities\File $sql)
	{
		$count = $this->loadFile($sql->getPath());
		if ($count === 0)
		{
			throw new Migrations\Exception("{$sql->file} neobsahuje zadne sql.");
		}
		return $count;
	}
